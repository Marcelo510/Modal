...
namespace Modal
{
    public partial class LINQ : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //HttpContext.Current.Application["someList"] = new List<string>  result;
            ...
            foreach (TablaPrueba row in result)
            {
                ...
                if (row.codigo == 15)
                {
                    sb.Append("<td style='width:100px;border: 1px solid #ccc'><input value='La funcion2' onclick='lafun2()' type='button'></td>");
                }
                else
                {
